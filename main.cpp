...
int extract_zip(string path, string file) {
	string cmd = "tools\\7z.exe x -o" + path + " " + file + " > NUL";
...
int main() {
	...
	extract_zip("D:\\test", "D:\\test\\atmosphere.zip");
	...
	extract_zip("D:\\test", "D:\\test\\hekate.zip");
