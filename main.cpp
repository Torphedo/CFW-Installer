...
int extract_zip(wstring path, wstring file) {
	cout << "Extracting...\n";
	try {
...
int main() {
	...
	extract_zip(L"D:\\test", L"D:\\test\\atmosphere.zip");
	...
	extract_zip(L"D:\\test", L"D:\\test\\hekate.zip");
    ...
    try {
        ...
        extractor.extract(L"E:\\Git\\CFW-Installer\\test\\atmosphere.zip", L"E:\\Git\\CFW-Installer\\test\\"); //extracting a simple archive
    }
    catch (const BitException& ex) {
